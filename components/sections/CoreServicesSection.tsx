      ...
      <div className="container relative">
        <div className="grid gap-9 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-start">
          <div data-motion="reveal" className="max-w-[760px]">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#8b552f] sm:text-sm">Realitný rastový systém</p>
            <h2
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-black/68 sm:text-lg">
              Web nie je brožúra. Má premieňať pozornosť na odhady ceny, kupujúcich, žiadosti o obhliadku a platené
              konzultácie. Mentoring ostáva iba malý sekundárny teaser.
            </p>
          </div>
          ...
          {services.map((service, index) => (
            <div key={service.slug} data-motion-item>
              <Link
                ...
                className="group relative grid min-h-[220px] overflow-hidden rounded-lg border border-white/62 bg-[#f8f4eb] p-5 shadow-[0_22px_58px_rgba(50,42,31,0.13)] transition duration-300 hover:-translate-y-1 hover:border-white/90 hover:shadow-[0_30px_72px_rgba(50,42,31,0.2)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#17130f]"
              >
                <Image
                  ...
                  className="object-cover opacity-[0.56] transition duration-500 group-hover:scale-105"
                />
                <span
                  className="absolute inset-0 bg-[linear-gradient(120deg,rgba(255,252,245,0.95)_0%,rgba(255,252,245,0.78)_42%,rgba(255,252,245,0.48)_100%)]"
                  aria-hidden="true"
                />
                ...
                <span className="relative mt-10 block self-end">
                  <span className="block font-serif text-[1.55rem] font-semibold leading-[1.02] text-[#080705]">{service.label}</span>
